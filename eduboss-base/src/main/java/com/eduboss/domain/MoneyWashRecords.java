 ...
 */
@Entity
@Table(name = "money_wash_records")
public class MoneyWashRecords implements java.io.Serializable {
	...
	@Column(name = "WASH_TIME", length = 20)
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "WASH_OPERATOR")
	public User getWashOperator() {
		return washOperator;
	}
	public void setWashOperator(User washOperator) {
		this.washOperator = washOperator;
	}
