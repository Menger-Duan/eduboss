 ...
 *      @see com.eduboss.datasource.ReadWriteDataSourceDecision
        @see com.eduboss.datasource.ReadWriteDataSourceDecision.DataSourceType
 *   
 *   默认按顺序轮询使用读库
 *   默认选择写库
 *   
...
//            logger.info("current determine write datasource");
            return writeDataSource;
        }
        
        if(ReadWriteDataSourceDecision.isChoiceNone()) {
            logger.info("no choice read/write, default determine write datasource");
            return writeDataSource;
        } 
