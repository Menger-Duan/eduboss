 ...
 *       @see com.eduboss.datasource.ReadWriteDataSourceDecision
 *       @see com.eduboss.datasource.ReadWriteDataSource
 * 
 * </pre>
 * @author Zhang Kaitao
 *
...
public class ReadWriteDataSourceProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        try {
            ...
            for(Entry<String, TransactionAttribute> entry : nameMap.entrySet()) {
                ...
                logger.info("read/write transaction process  method:{} force read:{}", methodName, isForceChoiceRead);
    ...
    public Object determineReadOrWriteDB(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (isChoiceReadDB(methodName)) {
            ReadWriteDataSourceDecision.markRead(methodName);
        } else {
            ReadWriteDataSourceDecision.markWrite(methodName);
        }
