...
public class RemainEvidenceAdjustSummaryVo {
	...
	private Set<RemainEvidenceAdjustItemVo> adjustItems = new HashSet<RemainEvidenceAdjustItemVo>();
	...
	public Set<RemainEvidenceAdjustItemVo> getAdjustItems() {
		return adjustItems;
	}
	public void setAdjustItems(Set<RemainEvidenceAdjustItemVo> adjustItems) {
