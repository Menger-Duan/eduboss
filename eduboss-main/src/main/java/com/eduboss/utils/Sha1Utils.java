...
public class Sha1Utils {
    ...
    public static void main(String [] args) throws DigestException {
        ...
        param.put("2","35465461321321");
        param.put("3","1497838847772");
        System.out.println(Sha1Utils.SHA1(param));
        System.out.println(Sha1Utils.getSha1("-p=t-w_up_7mj*36zt^^01--hdk1cv_vw)2#(4zuu=_kp1bgpo354654613213211497838847772"));
